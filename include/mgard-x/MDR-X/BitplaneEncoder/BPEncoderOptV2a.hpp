...
public:
  ...
  MGARDX_CONT
  BPEncoderOptV2aFunctor(SIZE n, int num_bitplanes, int exp,
  ...
  MGARDX_EXEC void EncodeBinary() {
    ...
    *encoded_bitplanes(0, num_batches + global_batch_start + my_batch_idx) = encoded_sign;
  }
...
public:
  ...
  MGARDX_CONT
  BPEncoderOptV2aKernel(SIZE n, int num_bitplanes, int exp,
                       SubArray<1, T_data, DeviceType> v,
                       SubArray<2, T_bitplane, DeviceType> encoded_bitplanes,
                       SubArray<2, T_error, DeviceType> level_errors_workspace)
      : n(n), num_bitplanes(num_bitplanes), exp(exp),
...
public:
  ...
  MGARDX_CONT
  BPDecoderOptV2aFunctor(SIZE n, SIZE starting_bitplane, int num_bitplanes,
                        int exp,
                        SubArray<2, T_bitplane, DeviceType> encoded_bitplanes,
...
public:
  ...
  MGARDX_CONT
  BPDecoderOptV2aKernel(SIZE n, SIZE starting_bitplane, int num_bitplanes,
                       int exp,
                       SubArray<2, T_bitplane, DeviceType> encoded_bitplanes,
                       SubArray<1, bool, DeviceType> signs,
                       SubArray<1, T_data, DeviceType> v)
...
public:
  ...
  void progressive_decode(SIZE n, SIZE starting_bitplanes, int num_bitplanes,
    ...
    if (num_bitplanes > 0) {
      DeviceLauncher<DeviceType>::Execute(
          BPDecoderOptV2aKernel<T_data, T_fp, T_sfp, T_bitplane, NegaBinary,
